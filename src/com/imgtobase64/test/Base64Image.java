...
/**
 * 说明:这个类是base64和图片的相互转换
 * 还有sun.misc.BASE64Decoder这个类是jdk本身提供的，只是在
 * 第一次把这个代码复制进来的时候会报错，这个时候 
 * 只需要在project build path中先移除JRE System Library，
 * 再添加库JRE System Library，重新编译后就一切正常了。 
 * @author zhengYu
 *
 */
...
public class Base64Image {
    public static void main(String[] args) {
        ...
        //这里图片的路径如果我用\是否可以？,是不可以的
        //1.必须要有 \\其中一个是转义字符; 2.首先文件夹必须有才可以(当然这里可以用代码来进行控制，就是说没有这个文件夹，可以通过代码去创建一个)
        GenerateImage(strImg, "D:\\test\\test.jpg"); 
        
        // 测试从图片文件转换为Base64编码
        System.out.println("imgurl is :"+GetImageStr("D:\\test\\test.jpg"));
    }
